...
- [Tech Stack](#️tech-stack-used)
- [Architecture & Data Pipeline Flow](#️architecture-&-data-pipeline-flow)
- [Medallion Architecture Setup](#Medallion-Architecture-Setup)
  - [1. Storage Layer (Amazon S3)](#1storage-layer-amazon-s3)
  - [2. Metadata & Processing (AWS Glue & Athena)](#2metadata--processing-aws-glue--athena)
